...
The output is a .txt file conatining the datastream named "Datastream_M_<M>_n_<T>_emb_<N_emb>_N_<N>_p_<p>_eta_<eta>_probs_<equal/dense/sparse_n_clus<n_clus>>.txt" if episodes are embedded and "Datastream_M_<M>_n_<T>_probs_<equal/dense/sparse_n_clus<n_clus>>.txt" if no episodes are embedded.
